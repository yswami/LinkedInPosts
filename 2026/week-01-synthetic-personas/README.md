...
Open the [Synthetic Persona Pre-flight Lab](https://yswami.github.io/LinkedInPosts/2026/week-01-synthetic-personas/) to:
...
## Watch the series in 60 seconds

Open the [silent-first visual summary](https://yswami.github.io/LinkedInPosts/2026/week-01-synthetic-personas/series.html) to see how the five-post experiment moves from an AI-generated character to a constrained hypothesis reviewer, an evidence-aware archetype, and optional OCEAN variation.

The LinkedIn-ready narrated video, synchronized browser audio, cover image, and upload-ready captions are available in [`media/`](media/). The browser animation includes sound-aware playback controls, keyboard support, scrubbing, reduced-motion behavior, and an accessible transcript. Its visual story remains understandable when muted.

## Start here

1. Use the [interactive lab](https://yswami.github.io/LinkedInPosts/2026/week-01-synthetic-personas/) or copy the [enterprise PPM reviewer prompt](prompts/enterprise-ppm-reviewer.md).
...
├── index.html
├── media/
│   ├── synthetic-persona-series-60s.mp4
│   ├── synthetic-persona-series-audio.m4a
│   ├── synthetic-persona-series-captions.srt
│   └── synthetic-persona-series-cover.jpg
├── ocean.html
├── prompts/
│   └── enterprise-ppm-reviewer.md
├── styles.css
├── series-animation.css
├── series-animation.js
├── series.html
├── tools/
│   ├── encode-series-frames.swift
│   ├── generate-series-soundbed.swift
│   ├── mix-series-audio.swift
│   ├── build-series-audio.cjs
│   ├── render-series-video.cjs
│   └── test-series-animation.cjs
├── .github/
│   └── workflows/pages.yml
├── templates/
│   ├── archetype-card.md
...
The animation page is available at `http://localhost:8000/series.html`.
